...
export default function RSVPPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-700 via-purple-800 to-indigo-900 flex items-center justify-center p-8">
      <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-lg rounded-xl shadow-lg p-8 border border-white/20 w-full max-w-md">
        <h1 className="text-3xl font-bold text-black mb-6 text-center">RSVP to Event</h1>
        <input
          type="text"
